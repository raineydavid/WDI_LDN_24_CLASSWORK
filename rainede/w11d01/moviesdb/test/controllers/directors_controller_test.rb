...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { image: @director.image, name: @director.name } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { image: @director.image, name: @director.name } }
