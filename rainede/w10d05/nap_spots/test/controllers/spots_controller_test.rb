...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { description: @spot.description, name: @spot.name, rating: @spot.rating } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { description: @spot.description, name: @spot.name, rating: @spot.rating } }
